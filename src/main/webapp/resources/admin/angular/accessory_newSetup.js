...
app.controller('productController', function($scope,$http,SharedService){
	...
	$scope.getAllBrand = function(){
		...
		$http({
				url : SharedService.apiAddress + "/api/products/Brand/2", //"http://localhost:9999//api/products/Brand/1
		        method : "POST",
		        headers:{
	...
	$scope.getAllModel = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/Model/2",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
	...
	$scope.getAllCategory = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/Category/2",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
	...
	$scope.insertProduct = function(product){
		$http({
				url : SharedService.apiAddress + "/api/products/newAccessory",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        },
...
//		    		$scope.clearText();
	...
	$scope.deleteProduct = function(id){
		$http({
				url : SharedService.apiAddress + "/api/products/newAccessory/"+id,
		        method : "DELETE",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
	...
	$scope.getAllProducts = function(page){
		//console.log(page);
		$http({
				url : SharedService.apiAddress +  "/api/products/newAccessory/all",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        },
	...
	$scope.getPageProduct = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/newAccessory/page",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        },
...
//		$scope.SpecTmp.product_id = -1 ;
	...
	$scope.getAllImages = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/newAccessory/newAccessoryImage/Accessory/"+$scope.ImageTmp.PRO_TMP.ID,
		        method : "GET",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
	...
	$scope.insertImage0 = function(image){
		...
		$http.post(SharedService.apiAddress + '/api/products/newAccessory/newAccessoryImage', fd, {
	...
	$scope.updateImage0 = function(image){
		...
		$http.put(SharedService.apiAddress + '/api/products/newAccessory/newAccessoryImage', fd, {
            transformRequest: angular.identity,
            headers: {'Content-Type': undefined }
        }).success(function(datas, status, headers, config) {
	    	if(datas.Message != "SUCCESS"){
	...
	$scope.deleteImage0 = function(id){
		$http({
				url : SharedService.apiAddress + "/api/products/newAccessory/newAccessoryImage/"+id,
		        method : "DELETE",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
