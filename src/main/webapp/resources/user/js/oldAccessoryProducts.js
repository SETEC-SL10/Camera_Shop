...
app.controller('ProductController', function($scope,$rootScope,$http,$window,$cookies,$cookieStore,SharedService){
	...
	$scope.getAllProduct = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/product-form/oldAccessoryForm",
		        method : "POST",
		        headers:{
...
//		    		$scope.Products = response.data.DATA;
	...
	$scope.getAllBrand = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/Brand/2",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
...
//		 			console.log($scope.Colors);
	...
	$scope.getPageProduct = function(){
		$http({
				url : SharedService.apiAddress + "/api/products/product-form/oldAccessoryForm/page",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        },
