...
app.controller('ProductController', function($scope,$rootScope,$http,$window,$cookies,$cookieStore){
	...
	$scope.getAllProduct = function(){
		$http({
				url : "http://localhost:9999/api/products/product-form/newAccessoryForm",
		        method : "POST",
		        headers:{
...
//		    		$scope.Products = response.data.DATA;
	...
	$scope.getAllCategory = function(){
		$http({
				url : "http://localhost:9999/api/products/Category/2",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
	...
	$scope.getAllBrand = function(){
		$http({
				url : "http://localhost:9999/api/products/Brand/2",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
	...
	$scope.getAllModel = function(){
		$http({
				url : "http://localhost:9999/api/products/Model/2",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        }
...
//		 			console.log($scope.Colors);
	...
	$scope.getPageProduct = function(){
		$http({
				url : "http://localhost:9999/api/products/product-form/newAccessoryForm/page",
		        method : "POST",
		        headers:{
		        	"accept": "application/json; charset=utf-8"
		        },
