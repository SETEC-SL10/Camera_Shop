...
<div class="stepwizard">
   ...
   <form >
    <div class="row setup-content shippingAddress" id="step-1">
       <div class="form-group col-md-7#">
             <label class="control-label">First Name</label>
            <input  maxlength="100" type="text" class="form-control" placeholder="First Name"  />
            <br>
            
             <label class="control-label">Last Name</label>
            <input  maxlength="100" type="text" class="form-control" placeholder="Last Name"  />
            <br>
            
            <label class="control-label">Gender</label>
            <input  maxlength="100" type="text" class="form-control" placeholder="Gender"  />
            <br>
            
             <label class="control-label">Phone</label>
            <input  maxlength="100" type="text" class="form-control" placeholder="Phone"  />
            <br>
            ...
            <br>
             ...
             <textarea name="" id="" cols="30" rows="10" class="form-control" placeholder="Address"></textarea>
            <br>
